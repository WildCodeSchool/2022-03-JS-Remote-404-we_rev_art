...
-- -----------------------------------------------------
-- Table `werevart`.`contacttype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `werevart`.`contacttype` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `werevart`.`technique`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `werevart`.`technique` (
  `id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `werevart`.`artwork` (
  ...
  INDEX `fk_artwork_technique1_idx` (`technique_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_artwork_picture2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_artwork_technique1`
    FOREIGN KEY (`technique_id`)
    REFERENCES `werevart`.`technique` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `werevart`.`profil_has_typeaccount`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `werevart`.`profil_has_typeaccount` (
  `profil_id` VARCHAR(255) NOT NULL,
  `typeaccount_id` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`profil_id`, `typeaccount_id`),
  INDEX `fk_profil_has_typeaccount_typeaccount1_idx` (`typeaccount_id` ASC) VISIBLE,
  INDEX `fk_profil_has_typeaccount_profil1_idx` (`profil_id` ASC) VISIBLE,
  CONSTRAINT `fk_profil_has_typeaccount_profil1`
    FOREIGN KEY (`profil_id`)
    REFERENCES `werevart`.`profil` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_profil_has_typeaccount_typeaccount1`
...
-- -----------------------------------------------------
-- Table `werevart`.`profil_has_contacttype`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `werevart`.`profil_has_contacttype` (
  `profil_id` VARCHAR(255) NOT NULL,
  `contacttype_id` INT NOT NULL,
  PRIMARY KEY (`profil_id`, `contacttype_id`),
  INDEX `fk_profil_has_contacttype_contacttype1_idx` (`contacttype_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_profil_has_contacttype_contacttype1`
    ...
    REFERENCES `werevart`.`contacttype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
